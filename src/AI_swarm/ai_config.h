...
#define AI_TASK_STACKSIZE 4096  //kp was genug/zu viel - MIST
#define AI_TASK_PRIO 3			//hier einfaches aber evtl. schlechtes tuning m�glich - Maximum 6, je h�her desto wichtiger (idle hat 0), task der l�uft hat immer die h�chste prio der aktivierbaren tasks
